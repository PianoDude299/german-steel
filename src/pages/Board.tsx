              ...
              <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center">
                ...
                >
                  ...
                  <div className="text-center">
                    <h3 className="text-2xl font-sans font-semibold text-yellow-400 mb-1">
                      {member.name}
                    </h3>
                ...
                >
                  ...
                  <blockquote className="relative z-10 mb-8">
                    <p className="text-2xl lg:text-2xl font-sans italic text-white leading-relaxed mb-6">
                      {member.quote}
                    </p>
                  </blockquote>
                  <div className="relative z-10">
