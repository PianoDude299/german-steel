...
const services: Service[] = [
  ...
  },
  {
    ...
    image: "/images/services/Detailing-Service-&-BIM.jpg",
  ...
  },
  {
    ...
    image: "/images/services/Painting-Surface-Treatmeant.jpg",
  ...
  },
  {
    ...
    image: "/images/services/structural-steel-erection-services.jpg",
  ...
  },
  {
    ...
    image: "/images/services/Decking-Roofing-&-Cladding.jpg",
  ...
  },
  {
    ...
    image: "/images/services/Value-Engineering.jpg",
  ...
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: '#222E50' }}>
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-blue-900 via-slate-800 to-blue-900 opacity-80 pointer-events-none" style={{ zIndex: 2 }} />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                ...
                >
                  <div className="bg-gradient-to-br from-blue-900/50 to-slate-800/50 rounded-2xl border border-yellow-400/30 h-full hover:border-yellow-400/60 hover:shadow-2xl hover:shadow-yellow-400/10 hover:scale-105 transition-all duration-300 overflow-hidden">
                    {/* Service Image */}
