      ...
      {expandedCard && expandedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-6xl max-h-[90vh] bg-gradient-to-br from-gray-900 to-black border border-yellow-400/30 rounded-2xl overflow-hidden shadow-2xl animate-modal-in">
            ...
            <button
              onClick={handleCloseExpanded}
              className="absolute top-6 right-6 z-10 w-10 h-10 bg-blue-900/50 backdrop-blur-sm border border-yellow-400/30 rounded-full flex items-center justify-center text-yellow-400 hover:bg-yellow-400/20 hover:border-yellow-400 transition-all duration-200"
            >
              <X className="w-5 h-5" />
            </button>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-blue-900/30 p-4 rounded-lg border border-yellow-400/20">
