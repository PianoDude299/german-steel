...
import { CheckCircle, Target, Eye, Users, Award, Clock,ShieldCheck,DollarSign,Settings, Globe } from 'lucide-react';
...
const Content: React.FC = () => {
  ...
  const whyChooseUsPoints = [
    { icon: <Clock className="w-6 h-6" />, text: "Ontime completion of projects" },
    { icon: <Settings  className="w-6 h-6" />, text: "Strong In-house Technical / Design team with 30+ Engineers & Modelers" },
    { icon: <DollarSign  className="w-6 h-6" />, text: "Competitive pricing" },
    { icon: <ShieldCheck  className="w-6 h-6" />, text: "Professional service without shortcuts" },
    { icon: <CheckCircle  className="w-6 h-6" />, text: "Full-service offerings, including design, fabrication, and erection" },
    { icon: <Award  className="w-6 h-6" />, text: "Over 18 years of industry experience" },
  ...
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: '#222E50' }}>
      {/* Particle Background */}
      <div className="fixed inset-0 w-full" style={{ height: '400vh', zIndex: 1, pointerEvents: 'none' }}>
        <ParticleBackground />
      </div>
              ...
              <div className="lg:col-span-1">
                <div className="bg-gradient-to-br from-black/50 to-gray-900/50 p-8 rounded-2xl border border-yellow-400/30 h-full">
                  ...
                  <div className="space-y-4 text-gray-300 font-serif">
                    <p className="text-gray-300 leading-relaxed font-serif">
                      Deliver high-quality, precision-engineered steel structures that meet the highest standards of durability and safety.
                    </p>
                    <p className="text-gray-300 leading-relaxed font-serif">
                      Provide reliable, cost-effective, and timely contracting solutions that consistently exceed client expectations.
                    </p>
                    <p className="text-gray-300 leading-relaxed font-serif">
                      Promote sustainability by incorporating eco-conscious practices in our construction processes.
                    </p>
                    <p className="text-gray-300 leading-relaxed font-serif">
                      Build long-term partnerships through professionalism, transparency, and exceptional service.
                    </p>
                    <p className="text-gray-300 leading-relaxed font-serif">
                      Combine local expertise with global best practices to actively support the UAE’s infrastructure and development goals.
                    </p>
                  </div>
                </div>
              </div>
