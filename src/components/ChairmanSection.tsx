...
const ChairmanSection: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="min-h-screen relative" style={{ backgroundColor: '#222E50' }}>
              ...
              <div className="w-80 h-80 relative">
                <div 
                  ...
                  style={{
                    ...
                    backgroundImage: 'url(/images/chairman2.jpg)',
          ...
          <div className={`lg:col-span-3 relative transition-all duration-1000 delay-300 ${
            ...
            <blockquote className="relative z-10 mb-8">
              <p className="text-2xl lg:text-2xl font-serif italic text-white leading-relaxed mb-6">
                "At German Steel, steel engineering is not merely a craft—it is a commitment. Over the past two decades, we have played a vital role in shaping the UAE’s skyline with precision-driven Steel structures that stand the test of time.<br></br><br></br>
From complex high-rise frames to fast-track industrial projects, our legacy is built on engineering integrity, customer trust, and an unrelenting focus on quality."
            ...
            <div className="relative z-10">
              <p className="text-gray-400 text-lg leading-relaxed font-sans">
                Over the years, German Steel has evolved into one of the UAE's most trusted names in steel construction. With full in-house capability—from design, fabrication, to site installation—we bring every project to life with safety, speed, and structural excellence at its core.<br></br><br></br>
                Our continuous investment in innovation, workforce development, and compliance with international standards reflects our vision: <i><u><b>to be the partner of choice for steel solutions that define modern infrastructure.</b></u></i><br></br><br></br>
