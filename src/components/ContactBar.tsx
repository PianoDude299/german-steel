...
const ContactBar: React.FC = () => {
  return (
    <div className="relative z-20">
      ...
      <div className="w-full h-0.5 bg-cyan-10"></div>
      
      {/* Contact bar */}
      <div className="bg-cyan-400/10 backdrop-blur-md border-t border-cyan-400/40">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-8">
              <div className="flex items-center space-x-2 text-white">
                ...
                <span className="font-semibold text-md">+971 6 7486133</span>
              </div>
              
              <div className="flex items-center space-x-2 text-white">
                <Mail className="w-6 h-6" />
                <span className="font-semibold text-md">info@germansteel.me</span>
              </div>
              
              <div className="flex items-center space-x-2 text-white">
                <Clock className="w-6 h-6" />
                <span className="font-semibold text-md">Mon–Sat: 8 AM – 6 PM</span>
              </div>
            </div>
